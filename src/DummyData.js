export const PostList = [
  {
    id: 0,
    title:
      "Nội dung bài post này là của tôi nhé các bạn trẻ thân yêu ơi ơi ơi ơi ơi ơi ơi ơi ơi ơi",
    imgUrl: "/assets/post/1.jpeg",
    like: 10,
    userId: 2,
    comment: 5,
    share: 3,
